...
$('.waifu-tool .fa-drivers-license-o').click(function(){
    if(model_p===22){
        loadlive2d('live2d','https://api.muir.fun/model/api.php?p=22&id='+m22_id);
        model_p = 33;
        showMessage('33援交有点累了，现在该我上场了',4000)
    }else{
        loadlive2d('live2d','https://api.muir.fun/model/api.php?p=33&id='+m33_id);
        model_p = 22;
...
loadlive2d('live2d','https://api.muir.fun/model/api.php?p=33');
...
function showHitokoto(){
    $.get("https://api.muir.fun/hitokoto",function(result){
        showMessage(result)
    })
}
